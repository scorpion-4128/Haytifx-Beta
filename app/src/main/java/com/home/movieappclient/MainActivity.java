...
public class MainActivity extends AppCompatActivity implements MovieItemClickListenerNew {
    ...
    private void addAllMovies(){
        ...
        animatedforadultsmovies=new ArrayList<>();
        ...
        martialartsmovies=new ArrayList<>();
        ...
        mDatabaserefence.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    ...
                    }else if(upload.getVideo_category().equals("Animated for Adults")){
                        sportmovies.add(upload);
                    }if(upload.getVideo_category().equals("Sports")){
                        sportmovies.add(upload);
                    }else if(upload.getVideo_category().equals("Adventure")){
                    ...
                    else if(upload.getVideo_category().equals("Martial Arts")) {
                        romanticmovies.add(upload);
                    }if(upload.getVideo_category().equals("Thrill")){
                        sportmovies.add(upload);

                    }
                    else if(upload.getVideo_category().equals("Surnatural")) {
                        surnaturalmovies.add(upload);
                    }if(upload.getVideo_category().equals("Series")){
                        serieMovies.add(upload);
    ...
    private void movieviewtab() {
        ...
        tabActionMovies.addTab(tabActionMovies.newTab().setText("Martial Arts"));
        tabActionMovies.addTab(tabActionMovies.newTab().setText("Romantic"));
        tabActionMovies.addTab(tabActionMovies.newTab().setText("Science Fiction"));
        tabActionMovies.addTab(tabActionMovies.newTab().setText("Series"));
        tabActionMovies.addTab(tabActionMovies.newTab().setText("Sports"));
        tabActionMovies.addTab(tabActionMovies.newTab().setText("Surnatural"));
        tabActionMovies.addTab(tabActionMovies.newTab().setText("thrill"));
    ...
    private void getActionMovies(){
        ...
        moviesShowAdapter.notifyDataSetChanged();
        Toast.makeText(MainActivity.this, "Action movies Seleted", Toast.LENGTH_SHORT).show();
    }



    private void getHorrorMovies() {
        moviesShowAdapter = new MoviesShowAdapter(this, horrormovies,this);
        //adding adapter to recyclerview
        tab.setAdapter(moviesShowAdapter);
        tab.setLayoutManager(new LinearLayoutManager(getApplicationContext(),LinearLayoutManager.HORIZONTAL,false));
        moviesShowAdapter.notifyDataSetChanged();
        Toast.makeText(MainActivity.this, "Horror movies Seleted", Toast.LENGTH_SHORT).show();
    }

    private void getMartialartsMovies() {
        moviesShowAdapter = new MoviesShowAdapter(this, martialartsmovies,this);
        //adding adapter to recyclerview
        tab.setAdapter(moviesShowAdapter);
        tab.setLayoutManager(new LinearLayoutManager(getApplicationContext(),LinearLayoutManager.HORIZONTAL,false));
        moviesShowAdapter.notifyDataSetChanged();
        Toast.makeText(MainActivity.this, "Martial Arts movies Seleted", Toast.LENGTH_SHORT).show();
    }

    private void getSerieMovies() {
        moviesShowAdapter = new MoviesShowAdapter(this, serieMovies,this);
        //adding adapter to recyclerview
        tab.setAdapter(moviesShowAdapter);
        tab.setLayoutManager(new LinearLayoutManager(getApplicationContext(),LinearLayoutManager.HORIZONTAL,false));
        moviesShowAdapter.notifyDataSetChanged();
        Toast.makeText(MainActivity.this, "Series Parts Seleted", Toast.LENGTH_SHORT).show();
    }

    private void getAnimatedMovies(){
        moviesShowAdapter = new MoviesShowAdapter(this, animatedforadultsmovies,this);
        //adding adapter to recyclerview
        tab.setAdapter(moviesShowAdapter);
        tab.setLayoutManager(new LinearLayoutManager(getApplicationContext(),LinearLayoutManager.HORIZONTAL,false));
        moviesShowAdapter.notifyDataSetChanged();
        Toast.makeText(MainActivity.this, "Animated movies Seleted", Toast.LENGTH_SHORT).show();
    }

    private void getSurnaturalMovies() {
        moviesShowAdapter = new MoviesShowAdapter(this, surnaturalmovies,this);
        //adding adapter to recyclerview
        tab.setAdapter(moviesShowAdapter);
        tab.setLayoutManager(new LinearLayoutManager(getApplicationContext(),LinearLayoutManager.HORIZONTAL,false));
        moviesShowAdapter.notifyDataSetChanged();
        Toast.makeText(MainActivity.this, "Surnatural movies Seleted", Toast.LENGTH_SHORT).show();
    }
    private void getThrillMovies() {
        moviesShowAdapter = new MoviesShowAdapter(this, thrillmovies,this);
        //adding adapter to recyclerview
        tab.setAdapter(moviesShowAdapter);
        tab.setLayoutManager(new LinearLayoutManager(getApplicationContext(),LinearLayoutManager.HORIZONTAL,false));
        moviesShowAdapter.notifyDataSetChanged();
        Toast.makeText(MainActivity.this, "Thrill movies Seleted", Toast.LENGTH_SHORT).show();
    }

    private void getScienceFictionMovies() {
        moviesShowAdapter = new MoviesShowAdapter(this, sciencefictionmovies,this);
        //adding adapter to recyclerview
        tab.setAdapter(moviesShowAdapter);
        tab.setLayoutManager(new LinearLayoutManager(getApplicationContext(),LinearLayoutManager.HORIZONTAL,false));
        moviesShowAdapter.notifyDataSetChanged();
        Toast.makeText(MainActivity.this, "Science Fiction movies Seleted", Toast.LENGTH_SHORT).show();
    }
    ...
    private void getSportMovies(){
        ...
        tab.setLayoutManager(new LinearLayoutManager(getApplicationContext(),LinearLayoutManager.HORIZONTAL,false));
        moviesShowAdapter.notifyDataSetChanged();
        Toast.makeText(MainActivity.this, "Sport movies Seleted", Toast.LENGTH_SHORT).show();
    ...
    private void getAdvantureMovies(){
        ...
        tab.setLayoutManager(new LinearLayoutManager(getApplicationContext(),LinearLayoutManager.HORIZONTAL,false));
        moviesShowAdapter.notifyDataSetChanged();
        Toast.makeText(MainActivity.this, "Adventure movies Seleted", Toast.LENGTH_SHORT).show();
    ...
    private void getRomanticMovies(){
        ...
        tab.setLayoutManager(new LinearLayoutManager(getApplicationContext(),LinearLayoutManager.HORIZONTAL,false));
        moviesShowAdapter.notifyDataSetChanged();
        Toast.makeText(MainActivity.this, "Romantic movies Seleted", Toast.LENGTH_SHORT).show();
    ...
    private void getComedyMovies(){
        ...
        tab.setLayoutManager(new LinearLayoutManager(getApplicationContext(),LinearLayoutManager.HORIZONTAL,false));
        moviesShowAdapter.notifyDataSetChanged();
        Toast.makeText(MainActivity.this, "Comedy movies Seleted", Toast.LENGTH_SHORT).show();
